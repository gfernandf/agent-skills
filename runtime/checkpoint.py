...
def _serialize_step_result(sr: StepResult) -> dict[str, Any]:
    return {
        ...
        "primary_binding_id": sr.primary_binding_id,
        "fallback_chain": sr.fallback_chain,
        "binding_attempts": sr.binding_attempts,
...
def _restore_step_result(d: dict[str, Any]) -> StepResult:
    return StepResult(
        ...
        primary_binding_id=d.get("primary_binding_id"),
        fallback_chain=d.get("fallback_chain"),
        binding_attempts=d.get("binding_attempts"),
