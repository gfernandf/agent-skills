...
# Backward-compat aliases for internal callers still using legacy names.
prepare_officialization_package = prepare_promotion_package
validate_officialization_package = validate_promotion_package
