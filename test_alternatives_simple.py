...
goal = (
    "Should we enter the legaltech market? We have no prior legal industry experience."
)
...
print(
    "\n[OK] alternatives_evaluated:",
    json.dumps(result.get("alternatives_evaluated"), indent=2),
)
...
assert result["confidence_score"] <= 0.65, (
    f"Domain cap not applied: {result['confidence_score']}"
)
